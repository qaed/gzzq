package nc.ui.gl.reconcile.query.command;
...
import nc.ui.gl.pubreconcile.ReconcileQueryUI;
...
public class OppCommand extends ReconcileQueryCommand {
	public OppCommand() {
	}
	...
	public void execute() {
		...
		ReconcileQueryUI clientui = getClientUI();
		...
		if (2 == Integer.parseInt(state.toString())) {
			...
			try {
				...
				Logger.error(e.getMessage(), e);
				FiUif2MsgUtil.showUif2DetailMessage(getClientUI(), NCLangRes4VoTransl.getNCLangRes().getStrByID("contrast_0", "02002002-0151"), e.getCause()
						.getMessage());
			}
	...
	public int getCommandcode() {
		return ReconcileQueryBtn.OPP.ordinal();
	}
}